...
public class DefaultJeepOrderService implements JeepOrderService {
   ...
   * @return
   */
  public List<Option> getOption(OrderRequest orderRequest) {
   ...
   * @return
   */
  public Tire getTire(OrderRequest orderRequest) {
   ...
   * @return
   */
  public Engine getEngine(OrderRequest orderRequest) {
   ...
   * @return
   */
  public Color getColor(OrderRequest orderRequest) {
   ...
   * @return
   */
  public Jeep getModel(OrderRequest orderRequest) {
    return jeepOrderDao
